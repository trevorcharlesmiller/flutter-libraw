...
class FlutterLibRawBindings {
  ...
  void libraw_set_makernotes_handler(
    ffi.Pointer<libraw_data_t> arg0,
    exif_parser_callback cb,
    ffi.Pointer<ffi.Void> datap,
  ) {
    return _libraw_set_makernotes_handler(
      arg0,
      cb,
      datap,
    );
  ...
  late final _libraw_set_makernotes_handlerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<libraw_data_t>, exif_parser_callback,
              ffi.Pointer<ffi.Void>)>>('libraw_set_makernotes_handler');
  late final _libraw_set_makernotes_handler =
      _libraw_set_makernotes_handlerPtr.asFunction<
          void Function(ffi.Pointer<libraw_data_t>, exif_parser_callback,
              ffi.Pointer<ffi.Void>)>();
  ...
  int libraw_adjust_to_raw_inset_crop(
    ffi.Pointer<libraw_data_t> lr,
    int mask,
    double maxcrop,
  ) {
    return _libraw_adjust_to_raw_inset_crop(
      lr,
      mask,
      maxcrop,
    );
  ...
  late final _libraw_adjust_to_raw_inset_cropPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<libraw_data_t>, ffi.UnsignedInt,
              ffi.Float)>>('libraw_adjust_to_raw_inset_crop');
  late final _libraw_adjust_to_raw_inset_crop =
      _libraw_adjust_to_raw_inset_cropPtr
          .asFunction<int Function(ffi.Pointer<libraw_data_t>, int, double)>();
  ...
  ffi.Pointer<ffi.Uint8> get_thumbnail_pointer(
    ffi.Pointer<libraw_data_t> ptr,
  ) {
    return _get_thumbnail_pointer(
      ptr,
    );
  }

  late final _get_thumbnail_pointerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Uint8> Function(
              ffi.Pointer<libraw_data_t>)>>('get_thumbnail_pointer');
  late final _get_thumbnail_pointer = _get_thumbnail_pointerPtr.asFunction<
      ffi.Pointer<ffi.Uint8> Function(ffi.Pointer<libraw_data_t>)>();

  int get_thumbnail_length(
    ffi.Pointer<libraw_data_t> ptr,
  ) {
    return _get_thumbnail_length(
      ptr,
    );
  }

  late final _get_thumbnail_lengthPtr = _lookup<
      ffi.NativeFunction<
          ffi.UnsignedInt Function(
              ffi.Pointer<libraw_data_t>)>>('get_thumbnail_length');
  late final _get_thumbnail_length = _get_thumbnail_lengthPtr
      .asFunction<int Function(ffi.Pointer<libraw_data_t>)>();
}

sealed class LibRaw_progress {
  static const LIBRAW_PROGRESS_START = 0;
  static const LIBRAW_PROGRESS_OPEN = 1;
  static const LIBRAW_PROGRESS_IDENTIFY = 2;
  static const LIBRAW_PROGRESS_SIZE_ADJUST = 4;
  static const LIBRAW_PROGRESS_LOAD_RAW = 8;
  static const LIBRAW_PROGRESS_RAW2_IMAGE = 16;
  static const LIBRAW_PROGRESS_REMOVE_ZEROES = 32;
  static const LIBRAW_PROGRESS_BAD_PIXELS = 64;
  static const LIBRAW_PROGRESS_DARK_FRAME = 128;
  static const LIBRAW_PROGRESS_FOVEON_INTERPOLATE = 256;
  static const LIBRAW_PROGRESS_SCALE_COLORS = 512;
  static const LIBRAW_PROGRESS_PRE_INTERPOLATE = 1024;
  static const LIBRAW_PROGRESS_INTERPOLATE = 2048;
  static const LIBRAW_PROGRESS_MIX_GREEN = 4096;
  static const LIBRAW_PROGRESS_MEDIAN_FILTER = 8192;
  static const LIBRAW_PROGRESS_HIGHLIGHTS = 16384;
  static const LIBRAW_PROGRESS_FUJI_ROTATE = 32768;
  static const LIBRAW_PROGRESS_FLIP = 65536;
  static const LIBRAW_PROGRESS_APPLY_PROFILE = 131072;
  static const LIBRAW_PROGRESS_CONVERT_RGB = 262144;
  static const LIBRAW_PROGRESS_STRETCH = 524288;

  /// reserved
  static const LIBRAW_PROGRESS_STAGE20 = 1048576;
  static const LIBRAW_PROGRESS_STAGE21 = 2097152;
  static const LIBRAW_PROGRESS_STAGE22 = 4194304;
  static const LIBRAW_PROGRESS_STAGE23 = 8388608;
  static const LIBRAW_PROGRESS_STAGE24 = 16777216;
  static const LIBRAW_PROGRESS_STAGE25 = 33554432;
  static const LIBRAW_PROGRESS_STAGE26 = 67108864;
  static const LIBRAW_PROGRESS_STAGE27 = 134217728;
  static const LIBRAW_PROGRESS_THUMB_LOAD = 268435456;
  static const LIBRAW_PROGRESS_TRESERVED1 = 536870912;
  static const LIBRAW_PROGRESS_TRESERVED2 = 1073741824;
}
...
final class libraw_nikon_makernotes_t extends ffi.Struct {
  ...
  @ffi.Array.multi([20])
  external ffi.Array<ffi.Uint8> PictureControlName;

  @ffi.Array.multi([20])
  external ffi.Array<ffi.Uint8> PictureControlBase;

  @ffi.UnsignedInt()
  external int ShotInfoVersion;

  @ffi.Array.multi([9])
  external ffi.Array<ffi.Uint8> ShotInfoFirmware;
...
final class libraw_fuji_info_t extends ffi.Struct {
  ...
  @ffi.Array.multi([33])
  external ffi.Array<ffi.Uint8> FujiModel;

  @ffi.Array.multi([33])
  external ffi.Array<ffi.Uint8> FujiModel2;
...
final class libraw_pentax_makernotes_t extends ffi.Struct {
  ...
  /// if (DynamicRangeExpansion[1] > 0) BLE+=DynamicRangeExpansion[0]
  @ffi.Array.multi([4])
...
sealed class LibRaw_thumbnail_formats {
  static const LIBRAW_THUMBNAIL_UNKNOWN = 0;
  static const LIBRAW_THUMBNAIL_JPEG = 1;
  static const LIBRAW_THUMBNAIL_BITMAP = 2;
  static const LIBRAW_THUMBNAIL_BITMAP16 = 3;
  static const LIBRAW_THUMBNAIL_LAYER = 4;
  static const LIBRAW_THUMBNAIL_ROLLEI = 5;
  static const LIBRAW_THUMBNAIL_H265 = 6;
  static const LIBRAW_THUMBNAIL_JPEGXL = 7;
}
...
sealed class LibRaw_internal_thumbnail_formats {
  static const LIBRAW_INTERNAL_THUMBNAIL_UNKNOWN = 0;
  static const LIBRAW_INTERNAL_THUMBNAIL_KODAK_THUMB = 1;
  static const LIBRAW_INTERNAL_THUMBNAIL_KODAK_YCBCR = 2;
  static const LIBRAW_INTERNAL_THUMBNAIL_KODAK_RGB = 3;
  static const LIBRAW_INTERNAL_THUMBNAIL_JPEG = 4;
  static const LIBRAW_INTERNAL_THUMBNAIL_LAYER = 5;
  static const LIBRAW_INTERNAL_THUMBNAIL_ROLLEI = 6;
  static const LIBRAW_INTERNAL_THUMBNAIL_PPM = 7;
  static const LIBRAW_INTERNAL_THUMBNAIL_PPM16 = 8;
  static const LIBRAW_INTERNAL_THUMBNAIL_X3F = 9;
  static const LIBRAW_INTERNAL_THUMBNAIL_DNG_YCBCR = 10;
  static const LIBRAW_INTERNAL_THUMBNAIL_JPEGXL = 11;
}
...
typedef data_callbackFunction = ffi.Void Function(
    ffi.Pointer<ffi.Void> data, ffi.Pointer<ffi.Uint8> file, INT64 offset);
typedef Dartdata_callbackFunction = void Function(
    ffi.Pointer<ffi.Void> data, ffi.Pointer<ffi.Uint8> file, DartINT64 offset);
...
typedef Dartprogress_callbackFunction = int Function(
    ffi.Pointer<ffi.Void> data, int stage, int iteration, int expected);
...
sealed class LibRaw_image_formats {
  static const LIBRAW_IMAGE_JPEG = 1;
  static const LIBRAW_IMAGE_BITMAP = 2;
  static const LIBRAW_IMAGE_JPEGXL = 3;
  static const LIBRAW_IMAGE_H265 = 4;
}
